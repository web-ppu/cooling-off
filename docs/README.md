...
2. [engineering/ai-prompt-v1.md](./engineering/ai-prompt-v1.md) — AI 프롬프트 Layer 1~4, 테스트 시나리오
...
과거 의사결정 기록. 평소에 안 읽어도 됨. "왜 이렇게 결정했지?" 궁금할 때 참조.
