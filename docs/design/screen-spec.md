...
- 로그인 취소 시 비로그인 홈으로 돌아간다.
- 로그인 실패 시 "로그인에 실패했습니다. 다시 시도해 주세요."를 표시한다.
...
- AI가 새 관점을 제시한 뒤: [결정하기] 버튼을 표시한다. 채팅 입력창도 유지한다.
...
- **왜?** — 충동구매 비용 설명
- **어떻게?** — "냉각 시간이 끝나면 AI 채팅으로 구매 이유를 다시 점검합니다"
- **원칙** — 설계 원칙 요약
- **주의 1** — "사용자 데이터는 로그인 계정 기준으로 저장됩니다."
- **주의 2** — "사용자 데이터는 이 브라우저에만 저장하지 않습니다."
- **주의 3** — "쿨링오프는 쇼핑중독 치료 도구가 아닙니다. 임상적 문제가 있다면 전문가의 도움을 권장합니다."
